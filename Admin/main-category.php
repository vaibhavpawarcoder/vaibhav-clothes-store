                                ...
                                <div class="col-md-9">
                                    ...
                                    ?>
                                        <form method="post" class="row g-3 needs-validation Category-box mt-2 mb-5 pt-5 pb-5" novalidate>
                                            ...
                                            <div class="col-md-12 mt-3">
                                                <label for="validationCustom01" class="form-label">List category Name</label>
                                                <input type="text" class="form-control mt-3" id="validationCustom01" value="<?php echo $row['category_list'] ?>" name="category_list" required>
                                                <div class="valid-feedback">
                                                    Looks good!
                                                </div>
                                            </div>
                                    ...
                                    if (isset($_POST['submit'])) {
                                        ...
                                        $updatequery="UPDATE category SET category='$category', category_list='$category_list' 
                                        WHERE ID= $ID_S";
